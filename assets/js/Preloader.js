...
Sizeer.Preloader.prototype = {
	preload: function () {
                         ...
                         this.load.image("button-pause", "assets/img/button-pause.png"); //PAUSE BUTTON
                         ...
                         this.load.spritesheet("button-mute", "assets/img/button-mute.png",110,113); //MUTE MUSIC BUTTON
                         this.load.spritesheet("button-prev", "assets/img/button-prev.png",106,94); //PREVIOUS BUTTON
                         ...
                         this.load.spritesheet("mach2", "assets/img/machines/mach2.png", 500, 500, 16);
                         ...
                         this.load.spritesheet("mach7", "assets/img/machines/mach7.png", 160, 238, 30);
